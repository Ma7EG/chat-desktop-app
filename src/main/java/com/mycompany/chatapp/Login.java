...
public class Login extends javax.swing.JPanel {
    ...
    /**
     * Setup images with high-quality scaling to prevent pixelation.
     */
    private void setupResponsiveImages() {
        // Scale the main login image to proper size with high quality
        ImageIcon loginImage = ResponsiveHelper.loadScaledImage(
                "/com/mycompany/chatapp/images/login 1.png", 320, 320);
        if (loginImage != null) {
            jLabel2.setIcon(loginImage);
        }

        // Scale the chat icon
        ImageIcon chatIcon = ResponsiveHelper.loadScaledImage(
                "/com/mycompany/chatapp/images/wpf_chat.png", 40, 40);
        if (chatIcon != null) {
            jLabel4.setIcon(chatIcon);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(
                new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/chatapp/images/wpf_chat.png"))); // NOI18N
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                .addContainerGap()
                                                .addComponent(btnGoToSignUp, javax.swing.GroupLayout.PREFERRED_SIZE,
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 144,
                                        Short.MAX_VALUE)
                                .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 360,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(71, 71, 71))
                        ...
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addComponent(jLabel3)
                                                .addGap(33, 33, 33)
                                                .addComponent(txtEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(9, 9, 9)
                                                ...
                                                .addComponent(btnGoToSignUp, javax.swing.GroupLayout.PREFERRED_SIZE, 33,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(28, 28, 28)
                                                .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 360,
