...
import com.mycompany.chatapp.pattern.builder.UserBuilder;
...
public class SignUp extends javax.swing.JFrame {
        ...
        private void initComponents() {
                ...
                jTextField4 = new javax.swing.JTextField(); // Phone number field
                ...
                jTextField4.setBackground(new java.awt.Color(32, 40, 58));
                jTextField4.setForeground(new java.awt.Color(153, 153, 153));
                jTextField4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Phone Number",
                                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
                                javax.swing.border.TitledBorder.DEFAULT_POSITION,
        ...
        private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
                ...
                if (email.isEmpty() || phone.isEmpty() || password.isEmpty() || confirmPassword.isEmpty()) {
                        JOptionPane.showMessageDialog(this,
                                        "Please fill in all fields (Email, Phone, Password)",
                                        "Validation Error",
                ...
                User newUser = new UserBuilder(email, password)
                                .setDisplayName(email.split("@")[0]) // Use email prefix as display name
                                .setPhone(phone)
                                .setStatus("online")
                                .build();
